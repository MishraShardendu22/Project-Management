  ...
  const features = [
    {
      ...
      description: "Create, update, and delete tasks easily. Stay organized and efficient.",
      icon: CheckCircle,
    },
    {
      title: "Project Organization",
      description: "Categorize tasks into projects and track progress effortlessly.",
      icon: Layout,
    },
    {
        ...
        <div className="container px-4 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="border-none shadow-lg bg-card/50 backdrop-blur-sm">
                <CardHeader>
